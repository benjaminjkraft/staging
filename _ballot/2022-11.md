...
- [Prop C (Homelessness Oversight Comission): <span class="endorsement">No</span>](#prop-c)
...
- Fleshman talks a lot about improving diversity and inclusion, but her plans to do so are unclear. She thinks it's too easy to fire bad teachers, and her answer to GrowSF's (very leading) question about the recall is a 600-word screed against "the POA, tech cocmpanies, and real estate developers".
...
<ul class="endorsements">
<li id="prop-c">Prop C (Homelessness Oversight Comission): <span class="endorsement">No</span></li>
</ul>
